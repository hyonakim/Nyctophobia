...
(0, _jquery2['default'])('.showTitle').hide(0).delay(1000).fadeIn(3000);
(0, _jquery2['default'])('.instruction').hide(0).delay(1000).fadeIn(3000);
(0, _jquery2['default'])('.tacotext').hide(0).delay(3000).fadeIn(3000).delay(3000).fadeOut(3000);
(0, _jquery2['default'])('.burgertext').hide(0).delay(3000).fadeIn(3000).delay(3000).fadeOut(3000);

//Player 1 Instance

var taco = new _player12['default']();

//Player 2 Instance

var burger = new _player22['default']();
...
p1attack.on('click', function () {
	...
	if (burger.health <= 0) {
		...
		(0, _jquery2['default'])('.slenderhidden').addClass('slendershow2');
...
p2attack.on('click', function () {
	...
	if (taco.health <= 0) {
		...
		(0, _jquery2['default'])('.slenderhidden').addClass('slendershow1');
...
},{"./player1":2,"./player2":3,"jquery":4,"moment":5,"underscore":6}],2:[function(require,module,exports){
"use strict";
